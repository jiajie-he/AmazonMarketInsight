package AmazonMarketInsight.tools;
...
public class Inserter {
	...
	public static void main(String[] args) throws SQLException {
		...
		UsersDao blogUsersDao = UsersDao.getInstance();
		PostsDao blogPostsDao = PostsDao.getInstance();
		PostCommentsDao blogCommentsDao = PostCommentsDao.getInstance();
...
//		administrator2 = administratorsDao.create(administrator2);
		Users blogUser = new Users("bu", "password", "bruce", "chhay", "email", "phone", date, true);
...
//		}
		Users bu1 = blogUsersDao.getUserFromUserName("bu");
		List<Users> buList1 = blogUsersDao.getUsersFromFirstName("bruce");
		System.out.format("Reading blog user: u:%s f:%s l:%s \n",
			bu1.getUserName(), bu1.getFirstName(), bu1.getLastName());
